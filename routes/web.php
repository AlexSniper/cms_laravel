...
//This route responsible for home page
...
Route::delete('/admin/user/{user}/destroy', [App\Http\Controllers\UserController::class, 'destroy'])->name('user.destroy');
...
Route::middleware(['role:admin','auth'])->group(function(){
 ...
 Route::get('admin/users',[App\Http\Controllers\IsAdminController::class, 'index'])->name('user.index');
});
